...
class Puppeteer {
  ...
  Future<Browser> launch(
    ...
    print("process path: " + executablePath);
    print("environment!: " + environment.toString());
    ...
    var webSocketUrl =
        await _waitForWebSocketUrl(chromeProcess).then<String?>((f) {
      print("passed string to socket : $f");

      return f;
    }).timeout(timeout, onTimeout: () {
      print(chromeProcess.toString() + "Process Timedout!!");
      return null;
    });
    print(webSocketUrl);
